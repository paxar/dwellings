...
class Charitable_Simple_Updates {
     ...
     */
    const DB_VERSION = '20158718'; 

    /**
     * @var string The product name. 
     */
    const NAME = 'Charitable Simple Updates'; 
    ...
    private function load_dependencies() {      
        ...
        require_once( $this->get_path( 'includes' ) . 'public/class-charitable-simple-updates-template.php' );
        require_once( $this->get_path( 'includes' ) . 'public/charitable-simple-updates-template-functions.php' );
        require_once( $this->get_path( 'includes' ) . 'shortcodes/class-charitable-simple-updates-shortcode.php' );
    ...
    private function register_shortcode() {
        add_shortcode( 'campaign_updates', array( 'Charitable_Simple_Updates_Shortcode', 'display' ) );
    }
    ...
    private function setup_licensing() {
        charitable_get_helper( 'licenses' )->register_licensed_product( 
            Charitable_Simple_Updates::NAME, 
            Charitable_Simple_Updates::AUTHOR, 
            Charitable_Simple_Updates::VERSION, 
            $this->plugin_file 
        );
    }
    ...
    private function setup_i18n() {
        if ( class_exists( 'Charitable_i18n' ) ) {
            ...
            require_once( $this->get_path( 'includes' ) . 'i18n/class-charitable-simple-updates-i18n.php' );

            Charitable_Simple_Updates_i18n::get_instance();
        }
    }
