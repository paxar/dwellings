...
if ( ! class_exists( 'Charitable_Stripe' ) ) :
	...
	class Charitable_Stripe {
		...
		private function load_dependencies() {
			require_once( $this->get_path( 'includes' ) . 'libraries/vendor/autoload.php' );
			require_once( $this->get_path( 'includes' ) . 'i18n/class-charitable-stripe-i18n.php' );
			require_once( $this->get_path( 'includes' ) . 'gateway/class-charitable-gateway-stripe.php' );
			require_once( $this->get_path( 'includes' ) . 'gateway/charitable-stripe-gateway-hooks.php' );

			/* Recurring Donations */
			if ( class_exists( 'Charitable_Recurring' ) ) {
				require_once( $this->get_path( 'includes' ) . 'recurring/class-charitable-stripe-recurring.php' );
				require_once( $this->get_path( 'includes' ) . 'recurring/charitable-stripe-recurring-hooks.php' );
			}
		}
