 ...
 */
add_action( 'transition_post_status', array( 'Charitable_Ambassadors_Email_New_Campaign', 'send_email' ), 10, 3 );
 ...
 */
add_action( 'transition_post_status', array( 'Charitable_Ambassadors_Email_Creator_Campaign_Submission', 'send_email' ), 10, 3 );
